    <nav class="h-16 shadow-sm flex items-center justify-between px-8"
        style="background-color: var(--bg-navbar); border-bottom: 1px solid var(--border-color);">
        <h1 class="text-lg font-bold" style="color: var(--text-primary);">Dashboard</h1>
